...
class C(BaseConstants):
    NAME_IN_URL = 'delegation_salient_price'
...
class Trivial_DecisionScreen(Page):
    ...
    template_name = '_static/templates/Trivial_DecisionScreen_SP.html'
    form_model = 'player'
...
class Simple_DecisionScreen(Page):
    ...
    template_name = '_static/templates/Simple_DecisionScreen_SP.html'
    form_model = 'player'
...
class Complex_DecisionScreen(Page):
    ...
    template_name = '_static/templates/Complex_DecisionScreen_SP.html'
    form_model = 'player'
...
class DelegationInstructions(Page):
    ...
    template_name='_static/templates/SalientPrice_DelegationInstructions.html'
...
class TrivialDelegation(Page):
    ...
    template_name='_static/templates/SP_TrivialDelegationDecision.html'
    form_model = 'player'
...
class SimpleDelegation(Page):
    ...
    template_name='_static/templates/SP_SimpleDelegationDecision.html'
    form_model = 'player'
...
class ComplexDelegation(Page):
    ...
    template_name='_static/templates/SP_ComplexDelegationDecision.html'
    form_model = 'player'
...
class SimpleDelegationWTP(Page):
    ...
    template_name='_static/templates/Simple_Delegation_SP.html'
    form_model = 'player'
...
class ComplexDelegationWTP(Page):
    ...
    template_name='_static/templates/Complex_Delegation_SP.html'
    form_model = 'player'
