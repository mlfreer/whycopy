...
class C(BaseConstants):
    NAME_IN_URL = 'delegation_wtp_investors_list'
...
class TrivialDelegationWTP(Page):
    ...
    template_name='_static/templates/Trivial_DelegationWTP_with_list.html'
    form_model = 'player'
...
class SimpleDelegationWTP(Page):
    ...
    template_name='_static/templates/Simple_DelegationWTP_with_list.html'
    form_model = 'player'
...
class ComplexDelegationWTP(Page):
    ...
    template_name='_static/templates/Complex_DelegationWTP_with_list.html'
    form_model = 'player'
