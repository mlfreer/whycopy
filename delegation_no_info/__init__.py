...
class C(BaseConstants):
    NAME_IN_URL = 'delegation_no_info'
    PLAYERS_PER_GROUP = None
    NUM_ROUNDS = 15
    BLOCK_SIZE = 5

    #------------------------------------------------------------
    # COSTS AND ENDOWMENTS
    #------------------------------------------------------------
...
def set_payoffs(player: Player):
    ...
    # initializing payoff with initial endowment
...
class DelegationInstructions(Page):
    ...
    template_name='_static/templates/DelegationInstructions_no_info.html'
...
class TrivialDelegation(Page):
    ...
    template_name='_static/templates/TrivialDelegationDecision_no_info.html'
    form_model = 'player'
...
class SimpleDelegation(Page):
    ...
    template_name='_static/templates/SimpleDelegationDecision_no_info.html'
    form_model = 'player'
...
class ComplexDelegation(Page):
    ...
    template_name='_static/templates/ComplexDelegationDecision_no_info.html'
    form_model = 'player'
